        ...
        <motion.div>
            <div className='bg-gradient-to-t from-[#ff5352] to-[#e14b4a] w-full h-screen'>
                <div className='content flex-col flex justify-center content-center items-center w-full h-full'  ref={container}>
                    <h1 className={`text-[14rem] text-[#1B065E] font-mabryBlack text-center uppercase`} >Site Web</h1>
                ...
                <div className='flex w-full h-screen bg-gradient-to-t from-[#ea5d5d] to-[#ff5352]'>
                    <p className='justify-center w-full flex font-mabryBlack text-[#1B065E] text-4xl'>Qu'est-ce qu'un bon site web ?</p>
