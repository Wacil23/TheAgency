        ...
        <div className="h-screen w-full" ref={diagonal}>
            <div className='diagonal w-full h-screen bg-[#2e1756] relative' >
                <div className='flex flex-col relative w-full h-full justify-around flex-wrap'>
                    <span className=' marketing absolute w-fit top-[25%] uppercase -translate-y-[50%] text-6xl left-[7%] font-mabryBlack'> marketing digital</span>
                    ...
                    <button className='decouvrir -mt-96 font-mabryBold text-[#2e1756] hover:text-white w-fit  p-4 rounded-2xl bg-[#ffca2b] opacity-0 transition-all flex items-center ml-[10%]'>Découvrir <BsArrowRightCircleFill className='ml-4' /></button>
