        ...
        <div className='h-screen  w-full bg-[#8a47ff] pt-24 flex flex-col'>
            ...
            <div ref={boxes} className="flex justify-around mx-32 mt-12 ">
                ...
                <div className='box2 flex flex-col items-center'>
                    <div className='w-28 h-28 bg-[#6e38cd] rounded-full relative step'>
                        <span className='text-white  absolute top-[50%] font-mabryLight -translate-x-[50%] -translate-y-[50%] text-6xl left-[50%]'>2</span>
                    </div>
                ...
                <div className='box3 flex flex-col items-center'>
                    <div className='w-28 h-28 bg-[#6e38cd] rounded-full relative step'>
                        <span className='text-white  absolute top-[50%] font-mabryLight -translate-x-[50%] -translate-y-[50%] text-6xl left-[50%]'>3</span>
                    </div>
            ...
            <Link to='/mon-projet' className='mt-28 font-mabryBold text-white hover:text-black w-fit self-center p-4 rounded-2xl bg-[#ffca2b] transition-all flex items-center'>Commencer <BsArrowRightCircleFill className='ml-4' /></Link>
        </div>
    )
}
