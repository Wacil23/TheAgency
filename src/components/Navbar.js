    ...
    <div className='w-full top-0 z-50 fixed' ref={container} >
      <div className=' h-20 flex justify-around items-center' >
        ...
        <ul className='flex text-white text-base mx-[15%]'  >
          ...
          <li className='ml-8 link2'><Link to='/site-web'>Site web</Link></li>
          <li className='ml-8 link4'><Link to='/marketing-digital'>Marketing digital</Link> </li>
          <li className='ml-8 link5'><Link to='/mission'>Notre missions</Link></li>
          <li className='ml-8 link6'><Link to='/faq'>FAQ</Link></li>
        </ul>
        <ul className='flex items-center text-base'>
          ...
          <li className='text-white link7' ref={link6}><Link to='/contact'>Contact</Link></li>
